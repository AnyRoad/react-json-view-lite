...
| onNodeExpandToggled | `(expanded: boolean, level: number, value: any, field?: string) => void` | Optional. This function will be called any time a node is expanded or closed. |
